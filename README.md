...
```Groovy
implementation 'com.google.cloud:google-cloud-beyondcorp-clientconnectorservices:0.8.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-beyondcorp-clientconnectorservices" % "0.8.0"
```
